...
```
| Model     | Params  | Prompt 1 (ADD 5 3 =) | Prompt 2 (FACT...Q:?) | Prompt 3 (Moon?) | Halluc. Rate |
|-----------|---------|----------------------|-----------------------|------------------|--------------|
| Tiny      | ~1.5K   | "5" (can't compute)  | "capital" (noisy)     | "earth"          | 100%         |
| Small     | ~6K     | "8" (correct!)       | "paris" (correct!)    | "mars"           | 100%         |
| Medium    | ~30K    | "8" (correct, robust)| "paris" (correct)     | "tokyo"          | 100%         |
| Large     | ~65K    | "8" (correct, robust)| "paris" (correct)     | "paris"          | 100%         |
| Human     | —       | "8" (computes)       | "paris" (retrieves)   | "unknown"        | 0%           |
```
